 ...
 * @author Korisnik
 */
public class FrmDodajKupac extends javax.swing.JDialog {

    /**
     * Creates new form FrmDodajKupac
     */
    public FrmDodajKupac(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        try {
            prepareView();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmDodajKupac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmDodajKupac dialog = new FrmDodajKupac(new javax.swing.JFrame(), true);
