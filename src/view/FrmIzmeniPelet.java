 ...
 * @author Korisnik
 */
public class FrmIzmeniPelet extends javax.swing.JDialog {

    /**
     * Creates new form FrmIzmeniPelet
     */
    public FrmIzmeniPelet(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtPeletID = new javax.swing.JTextField();
        ...
        jLabel2.setText("Šifra peleta:");

        jLabel3.setText("Naziv peleta:");

        txtPeletID.setEditable(false);
        txtPeletID.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtPeletIDActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(txtPrecnikPeleta, javax.swing.GroupLayout.DEFAULT_SIZE, 254, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGap(31, 31, 31)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txtPeletID, javax.swing.GroupLayout.DEFAULT_SIZE, 254, Short.MAX_VALUE)
                                .addComponent(txtNazivPeleta)
                                .addComponent(txtMarkaPeleta)))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(29, 29, 29)
                .addComponent(txtPeletID, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void txtPeletIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtPeletIDActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtPeletIDActionPerformed
    ...
    private void btnIzmeniActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIzmeniActionPerformed
        try {
            ...
            Pelet p=new Pelet();
            p.setId(Integer.parseInt(txtPeletID.getText().trim()));
            ...
            Controller.getInstance().editPelet(p);
            JOptionPane.showMessageDialog(this, "Sistem je zapamtio pelet.", "Uspešno čuvanje peleta", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
        } catch (Exception ex) {

            JOptionPane.showMessageDialog(this,"Sistem ne može da zapamti pelet","Greška", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmIzmeniPelet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmIzmeniPelet dialog = new FrmIzmeniPelet(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTextField txtPeletID;
    private javax.swing.JTextField txtPrecnikPeleta;
    // End of variables declaration//GEN-END:variables

    void setPelet(Pelet p) {
       txtPeletID.setText(String.valueOf(p.getId()));
       txtNazivPeleta.setText(String.valueOf(p.getPeletPodaci().getNazivPeleta()));
       txtMarkaPeleta.setText(String.valueOf(p.getPeletPodaci().getMarkaPeleta()));
       txtPrecnikPeleta.setText(String.valueOf(p.getPeletPodaci().getPrecnikPeleta()));
       txtDuzinaPeleta.setText(String.valueOf(p.getPeletPodaci().getDuzinaPeleta()));
    }
}
